...
> **ローカライズについて** · 見出しは翻訳済みです。コードと正確な API は英語原文を正とします。英語版：[English](/architecture/self-evolution)
...
- [Intelligence](/ja/architecture/intelligence)
- [Multi-agent](/ja/architecture/multi-agent)
- [Reflection engine](/ja/api/reflection-engine)
- [Task complexity analyzer](/ja/api/task-complexity-analyzer)
