...
> **현지화 안내** · 제목/구조는 번역되었습니다. 코드와 정확한 API는 영어 원문을 기준으로 하세요.영어 버전: [English](/architecture/self-evolution)
...
- [Intelligence](/ko/architecture/intelligence)
- [Multi-agent](/ko/architecture/multi-agent)
