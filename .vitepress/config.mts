...
const descriptionZh =
  '多代理编排引擎 — 25 家模型提供商 · 5 种规范拓扑 · 18 内置工具 · 6700+ 测试'
...
const head: HeadConfig[] = [
  ...
  [
    ...
    {
      name: 'keywords',
      content: 'multi-agent, orchestration, LLM, commander, AI agents, SSE, topology, 多代理, 编排',
    },
  ],
  ...
  return [
    {
      ...
      items: [{ text: 'Overview (Layer 1 & 2)', link: '/api/overview' }],
    },
    {
...
function guideSidebarZh(): DefaultTheme.SidebarItem[] {
  return [
    {
      text: '入门',
      items: [
        { text: '快速开始', link: '/zh/guide/getting-started' },
        { text: '为什么选 Commander', link: '/zh/guide/why-commander' },
        { text: '安装', link: '/zh/guide/installation' },
        { text: 'Web 控制台', link: '/zh/guide/web-console' },
    ...
    },
    {
      text: '实战手册',
      items: [
        { text: '概览', link: '/zh/guide/cookbook/' },
        { text: '安全审计仓库', link: '/zh/guide/cookbook/security-audit' },
      ],
    },
    {
      text: '进阶（英文）',
      items: [
        { text: '完整英文文档', link: '/guide/getting-started' },
    ...
    zh: {
      ...
      themeConfig: {
        ...
        nav: [
          ...
          { text: '为什么选它', link: '/zh/guide/why-commander' },
          { text: '实战手册', link: '/zh/guide/cookbook/' },
