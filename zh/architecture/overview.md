...
> **本地化说明** · 本页标题与结构已本地化；代码块与精确 API 以英文源为准。完整英文版：[English](/architecture/overview)
...
2. [Core Call Chain](/zh/architecture/core-call-chain) — request → result path  
3. [Multi-Agent Orchestration](/zh/architecture/multi-agent) — topologies and coordination  
4. [Agent Runtime](/zh/architecture/agent-runtime) — LLM → tools → verify → retry  
5. [Verification Pipeline](/zh/architecture/verification) — five quality gates  
